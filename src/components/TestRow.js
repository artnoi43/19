function TestRow({ data }) {
    return (
        <tr>
            ...
            <td className="relative">{data.tests_per_case ? data.tests_per_case : "N/A"}</td>
            <td>{data.new_tests ? data.new_tests : "N/A"}</td>
            <td className="relative">{data.new_tests_per_thousand ? data.new_tests_per_thousand : "N/A"}</td>
            ...
            <td className="relative">{data.total_tests_per_thousand ? data.total_tests_per_thousand : "N/A"}</td>
        </tr>
    )
}
